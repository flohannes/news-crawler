...
public class Run {
    ...
    public static void main(String[] args) {
        ...
        if ((args == null) || args.length != 3) {
            System.err.println("Parameters: <database path> <crawling interval in min:double> <image path>");
            System.exit(0);
        }
...
//        EmbeddedDerbyDB.getInstance(dbPath).createDatabase();
        ...
        new CrawlService(rssFeeds, dbPath, meanCrawlerInterval, imagePath).run();
    }
}
